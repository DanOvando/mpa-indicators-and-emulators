...
prep_run(run_name = "indicators_test",figure_text_size = 15) # loads packages and creates and returns some global variables for the analysis
...
Potential negaitve imapcts are not unique to MPAs, a quota could also have leakage into a non-quota species 
